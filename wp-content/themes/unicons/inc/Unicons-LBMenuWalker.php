...
class Unicons_LBMenuWalker extends Walker_Nav_Menu {
    ...
    public function start_lvl(&$output, $depth = 0, $args = array()) {
        ...
        $output .= "\n$indent<div data-submenu-content=\"data-submenu-content\" class=\"subnav\"><div class=\"grid\"><ul>\n";
    }
    ...
    public function end_lvl(&$output, $depth = 0, $args = array()) {
        $indent = str_repeat("\t", $depth);
        $output .= "$indent</ul><a href=\"javascript:void(0);\" title=\"close\" class=\"close\"><span class=\"fa fa-close\"></span></a></div></div>\n";
    }
    ...
    public function start_el(&$output, $item, $depth = 0, $args = array(), $id = 0) {
        ...
        if($args->has_children){
            $data_submenu = 'data-submenu="data-submenu"';
            $atts['data-trigger-submenu'] = 'data-trigger-submenu';
        }
        
        $output .= $indent . '<li' . $id . $class_names . $data_submenu .'>';
        ...
        $item_output .= $menu_sub ? $menu_sub : $args->link_before . $title . $args->link_after;
        $item_output .= '</a>';
